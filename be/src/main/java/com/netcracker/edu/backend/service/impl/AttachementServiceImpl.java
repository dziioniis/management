...
public class AttachementServiceImpl implements AttachementService {
    ...
    @Override
    public String saveAttachement(MultipartFile file,long taskId) {
        ...
        attachement.setTaskId(taskId);
        attachement.setUrl(path);
        attachement.setName(fileName);
        System.out.println(attachement.toString());
        attachementRepository.save(attachement);
        return path;
    }

    @Override
    public Iterable<Attachement> findByTask(long taskId) {
        System.out.println(taskId);
        return attachementRepository.findByTaskId(taskId);
    }
